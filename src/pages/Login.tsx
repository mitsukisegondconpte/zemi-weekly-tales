      ...
      <main className="flex-1 flex items-center justify-center py-12">
        <div className="w-full max-w-md px-6">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="••••••••"
                  className="w-full rounded-lg border border-input bg-background pl-10 pr-10 py-2.5 text-sm text-foreground focus:outline-none focus:ring-2 focus:ring-ring"
                />
          ...
          <p className="text-center text-sm text-muted-foreground mt-6">
            Pa gen kont? <Link to="/register" className="text-primary font-medium hover:underline">Kreye kont</Link>
          </p>
        </div>
      </main>
      <Footer />
